...
export default function App() {
  ...
  return (
    <div className="relative">
            ...
            <div className="grid gap-4 sm:hidden">
              {lotesFiltrados.map((lote) => (
                <div key={lote.id} className="bg-white rounded-xl shadow p-4">
                  ...
                  <p
                    className={`inline-block px-3 py-1 mt-2 text-xs rounded-full font-semibold ${
                ...
                <tbody>
                  {lotesFiltrados.map((lote) => (
                    ...
                    >
                      ...
                      <td
                        className={`px-3 py-2 rounded-full w-max font-semibold whitespace-nowrap ${
                          lote.status === "Disponível"
                            ? "bg-green-100 text-green-800"
                            : "bg-red-100 text-red-800"
                        }`}
      ...
      </div> {/* Fecha o div relativo z-10 */}
    </div>   {/* Fecha o div com className="relative" */}
  );
}
